...
def main():
  ...
  for app in config.apps:
    ...
    subprocess.call(app.stage_command(), stdout=sys.stderr, stderr=sys.stderr, shell=True)
    for c in app.configs:
      ...
      subprocess.call(app.run_command(c, delite_options), stdout=sys.stderr, stderr=sys.stderr, shell=True)
    os.chdir(hyperdsl_root)
